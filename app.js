/* SOAFAM Exam Simulator, Application Logic */

const ACCESS_CODE  = "SOAFAM9000";
const EXAM_SECONDS = 12600;
const PASSING_PCT  = 65;
const STORAGE_KEY  = "soafam_exam_state_v1";
const SIM_Q_COUNT  = 34;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const CLUSTER_LABEL = "Scenario";
const DOMAIN_LABELS = {"short_term_insurance_and_reinsurance_coverages": "Short-Term Insurance and Reinsurance Coverages", "severity_frequency_and_aggregate_models": "Severity Frequency and Aggregate Models", "parametric_estimation": "Parametric Estimation", "introduction_to_credibility": "Introduction to Credibility", "pricing_and_reserving_for_short_term_coverages": "Pricing and Reserving for Short-Term Coverages", "option_pricing_fundamentals": "Option Pricing Fundamentals", "long_term_coverages_and_retirement_programs": "Long-Term Coverages and Retirement Programs", "mortality_models": "Mortality Models", "present_value_random_variables": "Present Value Random Variables", "premium_and_policy_value_calculation": "Premium and Policy Value Calculation"};  // maps domain key -> human-readable label for display
